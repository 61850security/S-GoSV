...
int main(int argc, char *argv[])
{
	...
	for ( i=0; i<144; i++)
        ...
        /* extension fields*/
        plainText[inx++] = version1;
        plainText[inx++] = version2;
        plainText[inx++] = time_of_Current_key1;
        plainText[inx++] = time_of_Current_key2;
        plainText[inx++] = time_of_Next_key1;
        plainText[inx++] = time_of_Next_key2;
        plainText[inx++] = keyID1;
        plainText[inx++] = keyID2;
        plainText[inx++] = keyID3;
        plainText[inx++] = keyID4; 
	for ( p=0; p<32; p++)
