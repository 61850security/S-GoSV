...
int main(int argc, char *argv[])
{
    ...
    unsigned char InputData[16], Data[16],cipher_str[1024]="",plainText_str[274];
    ...
    double begin,end,time_spent,time_hmac=0,time_encrypt=0,time_hmac1;
	...
	time_hmac= (double)(end - begin) / CLOCKS_PER_SEC;	
         ...
         /* extension fields*/
        sendbuf[len++] = SEQUENCE_tag; // Sec Extention Tag. 1 byte 0x30
	sendbuf[len++] = SEQUENCE_length; //length of the extension 
	sendbuf[len++] = Auth_value_tag;  // Authentication value tag 0xA4. 
	sendbuf[len++] = Auth_length;
	sendbuf[len++] = version_tag; // version tag 0x80
	sendbuf[len++] = version_length; 
	sendbuf[len++] = version_value;
	sendbuf[len++] = time_of_Current_key_tag;
	sendbuf[len++] = time_of_Current_key_length;
	sendbuf[len++] = time_of_Current_key1;
	sendbuf[len++] = time_of_Current_key2;
	sendbuf[len++] = time_of_Current_key3;
	sendbuf[len++] = time_of_Current_key4;
	sendbuf[len++] = time_of_Next_key_tag;
	sendbuf[len++] = time_of_Next_key_length;
	sendbuf[len++] = time_of_Next_key_value;
	sendbuf[len++] = keyID_tag;
	sendbuf[len++] = keyID_length;
	sendbuf[len++] = keyID_value1;
	sendbuf[len++] = keyID_value2;
	sendbuf[len++] = keyID_value3;
	sendbuf[len++] = keyID_value4;
	sendbuf[len++] = mac_tag;
	sendbuf[len++] = mac_length;
...
Comilation of the program: 
     #gcc -o EandM_send EandM_send.c -L /usr/local/lib -lssl -lcrypto
